...
void ListTest::list1()
{
  ...
  ll::lv<int> l1(array1, array1 + 3);
  ll::lv<int> l2(array2, array2 + 2);
  ll::lv<int>::iterator i1 = l1.begin();
  ll::lv<int>::iterator i2 = l2.begin();
  ll::lv<int>::const_iterator ci(i1);
  ll::lv<int>::const_iterator ci1(ci);
  l1.splice(i1, l2);
  i1 = l1.begin();
  CPPUNIT_ASSERT( *i1++ == 1 );
  CPPUNIT_ASSERT( *i1++ == 4 );
  ...
  {
    ll::lv<char>::iterator l_char_ite;
    ll::lv<int>::iterator l_int_ite;
...
void ListTest::list2()
{
  ...
  ll::lv<int> l1(array1, array1 + 2);
  ll::lv<int> l2(array2, array2 + 2);
  ll::lv<int>::iterator i = l1.begin();
  i++;
...
void ListTest::list3()
{
  ...
  ll::lv<char> str(array, array + 6);
  ll::lv<char>::iterator i;
...
void ListTest::list4()
{
  ...
  CPPUNIT_ASSERT(std::distance(l1.begin(), l1.end()) == 6);
  CPPUNIT_ASSERT(std::distance(l2.begin(), l2.end()) == 0);

  l1.swap(l2);

  CPPUNIT_ASSERT(std::distance(l1.begin(), l1.end()) == 0);
  CPPUNIT_ASSERT(std::distance(l2.begin(), l2.end()) == 6);
}
...
{
  {
    ...
    size_t i;
    ll::lv<int>::iterator lit(l.begin());
    for (i = 0; i < 5; ++i) {
...
void ListTest::push_back()
{
  ...
  ll::lv<int>::reverse_iterator r = l.rbegin();
...
void ListTest::allocator_with_state()
{
  ...
  typedef ll::lv<int, StackAllocator<int> > ListInt;
  {
