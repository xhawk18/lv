...
void DequeTest::deque1()
{
  ...
  ll::lv<int>::iterator dit = d.begin();
  ll::lv<int>::const_iterator cdit(d.begin());
...
void DequeTest::allocator_with_state()
{
  ...
  {
    typedef ll::lv<int, StackAllocator<int> > DequeInt;
...
//This test check that lv implementation do not over optimize
...
void DequeTest::optimizations_check()
{
  ...
  ll::lv<PointEx> d2(d1.begin(), d1.end());
...
void DequeTest::erase()
{
  ...
  ll::lv<int>::iterator it(dint.begin() + 1);
  CPPUNIT_ASSERT( *it == 1 );
